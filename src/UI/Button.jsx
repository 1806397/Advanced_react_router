...
function Button({ children, disabled = false, to }) {
  const className = `focus:ring-yellow mt-2 inline-block rounded-full 
    bg-yellow-400 px-4 py-3 font-semibold uppercase 
    ...
    disabled:cursor-not-allowed disabled:bg-slate-600 sm:px-6 sm:py-4`;
  //
  if (to)
    return (
