...
function CartOverview() {
  ...
  return (
    <div className="safelist flex translate-y-0 items-center justify-between bg-stone-800 px-4 py-4 text-sm uppercase text-stone-200 ease-in sm:px-6 md:text-base">
